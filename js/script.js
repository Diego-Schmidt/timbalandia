...
function store(){
 ...
 // Le damos 300 TimbaCoins de regalo al usuario y colocamos su estado en Logged yes     
      ...
      let audio = new Audio('./assets/registrado.mp3');
      audio.loop = false;
      audio.play(); 
...
function check(){
  ...
  if(userName.value == storedName && userPw.value == storedPw){
      ...
      // document.getElementById("loginform-html").style.display = "none";
      paginaIndexLogged();
      let audio = new Audio('./assets/login.mp3');
      audio.loop = false;
      audio.play(); 
    //   window.setTimeout(function() {
  ...
  <div class="container my-0">
    <main id="principal">
      ...
      <div class="form-popup" id="miLogin">
        <div id="loginform-html" class="login text-default bg-success" style="--bs-bg-opacity: .9;">
          <form name='form-login'>
  ...
  <div class="px-3 py-2 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
          <li>
            <a href="" class="nav-link text-warning" onclick="paginaIndexNoLogged();return false;">
              <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#home"/></svg>
              Inicio
            </a>
          </li>
         ...
         <!-- codigo reservado para versiones futuras -->
          ...
          <li>
            <a href="#" class="nav-link text-warning" onclick="paginaLoteriaNoLogged();return false;">
              <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#grid"/></svg>
              Lotería
            </a>
          </li>
    ...
    <main id="principal">
      ...
      <div class="form-popup" id="miLogin">
        ...
        <div class="container py-1 escala">
          ...
          <div class="p-5 mb-4 bg-success rounded-3" style="--bs-bg-opacity: .9;">
...
function bgandPagina(){
  ...
  //   // sonido.play(); 
  // } 
  let audio = new Audio('./assets/entrar.mp3');
  audio.loop = false;
  audio.play(); 
  let audiobg = new Audio('./assets/bgmusic.mp3');
  audiobg.loop = true;
  audiobg.volume = 0.9,
  audiobg.play(); 
}
...
function isLogged(){
    ...
    document.getElementById("ingresarsalir").style.display = "block";
...
function salir(){
  ...
  if(pagina == "index.html"){
    ...
    document.getElementById("loginform-html").innerHTML = `<h6 class="text-default text-center border border-3 border-success rounded">Chau ${nombreLog}! <img src="./assets/logotriste.png" width="100px"/> </h6>`;
...
function comprarNumero(a,b){
  ...
  switch(true) {
    case (b == 400):
      sonido = new Audio(`./assets/compra4numeros.mp3`);
      sonido.loop = false;
      sonido.play(); 
      break;
    case (b == 800):
      sonido = new Audio(`./assets/compra8numeros.mp3`);
      sonido.loop = false;
      sonido.play()
      break;
    default:
    sonido = new Audio(`./assets/compra1numero.mp3`);
    sonido.loop = false;
    sonido.play(); 
  } 
